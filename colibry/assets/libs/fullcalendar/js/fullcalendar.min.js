...
! function (a) {
    ...
    var $a = ["Dom", "Lun", "Mar", "Mie", "Jue", "Vie", "Sab"],
        ...
        yb = Wa.Scroller = ya.extend({
            ...
            lockOverflow: function (a) {
                var b = this.overflowX,
                    c = this.overflowY;
                a = a || this.getScrollbarWidths(), "auto" === b && (b = a.top || a.bottom || this.scrollEl[0].scrollWidth - 1 > this.scrollEl[0].clientWidth ? "hidden" : "hidden"), "hidden" === c && (c = a.left || a.right || this.scrollEl[0].scrollHeight - 1 > this.scrollEl[0].clientHeight ? "hidden" : "hidden"), this.scrollEl.css({
                    "overflow-x": b,
                    "overflow-y": c
                })
            },
